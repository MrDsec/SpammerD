import mechanize,time,os,requests
...
class Payu:
	...
	def banner(self):
		...
		°======================°
		 ...
		 |    +  MrDseC  +    |
		°======================°
                SELAMAT MENGGUNAKAN BRO""")
		no=input('\033[1;31mNomor Target :')
		psn=input('\033[1;37mPesan :')
		self.main(no,psn)
	...
	def main(self,no,msg):
		...
		if 'SMS Gratis Telah Dikirim' in str(sub):
			print('[+] \033[1;36Sukses mengirim sms ke',no)
		elif 'Mohon Tunggu' in str(sub):
			print('[!] \033[1;32mTunggu beberapa saat untuk mengirim sms yang sama')
		else:
			print('[-] \033[1;31mGagal mengirim sms ke',no)
